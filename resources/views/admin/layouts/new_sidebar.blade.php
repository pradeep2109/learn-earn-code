                ...
                <div class="tab-content" id="v-pills-tabContent">
                    ...
                    <div class="tab-pane fade active show" id="v-pills-dashboard" role="tabpanel"
                        ...
                        <ul class="vertical-menu">
                            ...
                            <!-- user start  -->
                            <li class="{{ Nav::isRoute('user.index') }} {{ Nav::isRoute('user.subscribe') }} {{ Nav::isRoute('user.unsubscribe') }} {{ Nav::isRoute('user.last_7_days') }} {{ Nav::isRoute('user.add') }} {{ Nav::isRoute('user.edit') }}{{ Nav::isRoute('alluser.index') }} {{ Nav::isRoute('alluser.add') }} {{ Nav::isRoute('alluser.edit') }}{{ Nav::isRoute('allinstructor.index') }} {{ Nav::isRoute('allinstructor.add') }} {{ Nav::isRoute('allinstructor.edit') }}{{ Nav::isResource('roles') }}">
                                ...
                                <ul class="vertical-submenu">
                                    ...
                                    <li>
                                        <a class="{{ Nav::isResource('user') }}"
                                            href="{{route('user.subscribe')}}">{{ __('Subscribe Users') }}</a>
                                    </li>
                                    <li>
                                        <a class="{{ Nav::isResource('user') }}"
                                            href="{{route('user.last_7_days')}}">{{ __('Last 7 Days Register Users') }}</a>
                                    </li>
                                    <li>
                                        <a class="{{ Nav::isResource('user') }}"
                                            href="{{route('user.unsubscribe')}}">{{ __('Unsubscribe Users') }}</a>
                                    </li>
                                    <li>
                            ...
                            <li class="{{ Nav::isResource('faq') }} {{ Nav::isResource('faqinstructor') }}">
                                <a href="javaScript:void();" class="menu">
                                    ...
                                    <span>{{ __('Faq') }}<div class="sub-menu truncate">Faq Student, Faq Instructor</div></span>
                                    <i class="feather icon-chevron-right"></i>
                                </a>
                                <ul class="vertical-submenu">
