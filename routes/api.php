...
Route::post('add-device-token', 'Api\Auth\LoginController@addDeviceToken');
Route::post('fblogin', 'Api\Auth\LoginController@fblogin');
Route::post('googlelogin', 'Api\Auth\LoginController@googlelogin');
Route::post('applelogin', 'Api\Auth\LoginController@appleLogin');
...
Route::get('user-data/{user_id}','Api\UserApiController@userData');
});