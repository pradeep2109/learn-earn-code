...
Route::get('/welcomes', [App\Http\Controllers\ProgressBarController::class, 'index']);
...
Route::get('trans',function(){
    ...
    Route::middleware(['is_active', 'auth', 'maintanance_mode'])->group(function () {
        ...
        Route::middleware(['is_admin'])->group(function () {
            ...
            Route::post('/quickupdate/user/subscribe/{id}','QuickUpdateController@userQuickSubscribe')->name('user.quick.subscribe');   
            ...
            Route::get('/subscribe','UserController@viewSubscribeUser')->name('user.subscribe');
            Route::get('/last_7_days_register_user','UserController@viewLast7DaysUser')->name('user.last_7_days');
            Route::get('/unsubscribe','UserController@viewUnsubscribeUser')->name('user.unsubscribe');
            ...
            Route::prefix('alluser')->group(function (){
                ...
                Route::get('/subscribe','AlluserController@viewSubscribeUser')->name('allusers.subscribe');
                Route::get('/unsubscribe','AlluserController@viewUnsubscribeUser')->name('allusers.unsubscribe');
