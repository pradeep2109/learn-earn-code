    ...
    <div class="col-lg-12">
        <div class="card dashboard-card m-b-30">
                ...
                <div class="card-header">
                    <h5 class="card-box"><?php echo e(__('FAQStudent')); ?></h5>
                    <div>
                        <div class="widgetbar">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('faq.faq-student.delete')): ?>
                        <button type="button" class="float-right btn btn-danger-rgba mr-2" data-toggle="modal" data-target="#bulk_delete"><i
                                  ...
                                  <?php endif; ?>
                                  <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('faq.faq-student.create')): ?>
                          <a href="<?php echo e(url('faq/create')); ?>" class="float-right btn btn-primary-rgba mr-2"><i class="feather icon-plus mr-2"></i><?php echo e(__('Add FAQ')); ?></a>
                        <?php endif; ?>
                        </div>
                      </div>
                </div> 
                ...
                <div class="table-responsive">
                        ...
                        <tbody id="sortable">
                            ...
                            <tr class="sortable" id="id-<?php echo e($p->id); ?>">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <form id="bulk_delete_form" method="post"
                                                    action="<?php echo e(route('faq.bulk.delete')); ?>">
                                                    <?php echo csrf_field(); ?>
                                ...
                                <td>
                                    <label class="switch">
                                        <input class="faq" type="checkbox"  data-id="<?php echo e($p->id); ?>" name="status" <?php echo e($p->status == '1' ? 'checked' : ''); ?>>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('faq.faq-student.edit')): ?>
                                            <a class="dropdown-item" href="<?php echo e(url('faq/'.$p->id.'/edit')); ?>"><i class="feather icon-edit mr-2"></i><?php echo e(__('Edit')); ?></a>
                                            <?php endif; ?>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('faq.faq-student.delete')): ?>
                                    ...
                                    <div class="modal fade bd-example-modal-sm" id="delete<?php echo e($p->id); ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                        <div class="modal-dialog modal-sm">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <form method="post" action="<?php echo e(url('faq/'.$p->id)); ?>" class="pull-right">
...
<script type="text/javascript">
    $( function() {
     ...
     update: function (e, u) {
      ...
      $.ajax({
          url: "<?php echo e(route('faq_reposition')); ?>",
          type: 'get',
          data: data,
          dataType: 'json',
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/eui6ftgy1hdt/public_html/resources/views/admin/faq/index.blade.php ENDPATH**/ ?>