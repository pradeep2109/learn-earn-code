            ...
            <div class="form-group col-md-6">
              ...
              <div class="form-group col-md-6">
                ...
                <input name="address" value="<?php echo e($data->address); ?>" required rows="1" class="form-control"
                  placeholder="<?php echo e(__('Please')); ?> <?php echo e(__('Enter')); ?> address"></input>
              </div>
              <div class="form-group col-md-6">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/eui6ftgy1hdt/public_html/resources/views/admin/Institute/edit.blade.php ENDPATH**/ ?>