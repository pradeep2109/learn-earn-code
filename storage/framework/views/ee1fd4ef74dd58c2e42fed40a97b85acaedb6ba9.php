        ...
        <div class="card dashboard-card m-b-30">
          ...
          <div class="card-body">
            ...
            <form class="form" action="<?php echo e(route('affiliates.update')); ?>" method="POST" novalidate enctype="multipart/form-data">
              ...
              <div class="form-group col-md-12">
                <h4 class="box-title"><?php echo e(__('FrontSetting')); ?></h4>
              </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/eui6ftgy1hdt/public_html/resources/views/admin/affiliates/index.blade.php ENDPATH**/ ?>