            ...
            <div class="card dashboard-card m-b-30">
                <div class="card-header all-user-card-header">
                    <ul class="nav nav-pills" id="pills-tab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="false"><?php echo e(__('Users')); ?></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false"><?php echo e(__('Students')); ?></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="pills-contact-tab" data-toggle="pill" href="#pills-contact" role="tab" aria-controls="pills-contact" aria-selected="true"><?php echo e(__('Instructors')); ?></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="pills-admin-tab" data-toggle="pill" href="#pills-admin" role="tab" aria-controls="pills-admin" aria-selected="true"><?php echo e(__('Admins')); ?></a>
                        </li>
                    </ul>
                </div>
                <div class="mt-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 col-md-12 text-right menus-button">
                                        ...
                                        <button type="button" class="btn btn-danger-rgba mr-2 " data-toggle="modal"
                                            ...
                                            <?php endif; ?>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Alluser.delete')): ?>
                                            <a href="<?php echo e(route('alluser.add')); ?>" class="btn btn-primary-rgba mr-2"><i
                                    ...
                                    <table id="allusertable" class="table table-striped table-bordered" style="width: 100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>#</th>
                                                <th><?php echo e(__('Profile Picture')); ?></th>
                                                <th><?php echo e(__('User Detail')); ?></th>
                                                <th><?php echo e(__('Login As User')); ?></th>
                                                <th><?php echo e(__('Status')); ?></th>
                                                <th><?php echo e(__('Action')); ?></th>
                                            </tr>
                        ...
                        <div class="tab-pane fade" id="pills-admin" role="tabpanel" aria-labelledby="pills-admin-tab">
                            <div class="all-user-menu">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 col-md-12 text-right menus-button">
                                                <a href="<?php echo e(route('alladmin.add')); ?>" class="btn btn-primary-rgba mr-2"><i
...
<script type="text/javascript">
    $(function () {
      var table = $('#userstabl').DataTable({
          ...
          searchDelay : 1000,
          stateSave : true,
          ajax: "<?php echo e(route(Route::currentRouteName())); ?>",
          columns: [
    ...
    $(document).on("change", ".subscribe", function () {
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                if(data.msg){
                    var warning = new PNotify( {
                        title: 'Warning', text:data.msg, type: 'warning', desktop: {
                        desktop: true, icon: 'feather icon-thumbs-down'
                    }});
                }else{
                    var warning = new PNotify( {
...
<script type="text/javascript">
    $(function () {
      let get_url = "<?php echo e(Route::currentRouteName()); ?>";
      get_url = get_url.split('.')[1];
      let url = "<?php echo e(route('allusers.index')); ?>";
      if(get_url == 'subscribe' || get_url == 'unsubscribe'){
        url = url + '/' + get_url
      }
      console.log(url);
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/eui6ftgy1hdt/public_html/resources/views/admin/user/index.blade.php ENDPATH**/ ?>