                    ...
                    <table id="mailables_list" class="table table-responsive table-hover table-sm mb-0 penultimate-column-right">
                        <thead>
                            <tr>
                                ...
                                <th scope="col"><?php echo e(config('maileclipse.display_as_subject') ? __('Subject') : __('Namespace')); ?></th>
                        ...
                        <?php $__currentLoopData = $mailables->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mailable): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr id="mailable_item_<?php echo e($mailable['name']); ?>">
                                ...
                                <td class="text-muted" title="<?php echo e($mailable['namespace']); ?>"><?php echo e(config('maileclipse.display_as_subject') ? $mailable['subject'] : $mailable['namespace']); ?></td>
...
<?php echo $__env->make('maileclipse::layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/eui6ftgy1hdt/public_html/vendor/qoraiche/laravel-mail-editor/src/../resources/views/sections/mailables.blade.php ENDPATH**/ ?>