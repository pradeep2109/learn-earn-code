...
<?php $__env->startSection('title', 'Service - Admin'); ?>
       ...
       <div class="col-lg-12">
            <div class="card dashboard-card m-b-30">
                <div class="card-header">
                    ...
                    <div>
                      <div class="widgetbar">
                          <a href="<?php echo e(url('service/create')); ?>" class="btn btn-primary-rgba"><i class="feather icon-plus mr-2"></i><?php echo e(__("Add Service")); ?></a>
                      </div>                        
                    </div>
                  </div>
                <div class="card-body">
                               ...
                               <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton3">
                                        <a class="dropdown-item"   href="<?php echo e(route('service.edit',$data->id)); ?>"><i class="feather icon-edit mr-2"></i><?php echo e(__("Edit")); ?></a>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/eui6ftgy1hdt/public_html/resources/views/admin/service/index.blade.php ENDPATH**/ ?>