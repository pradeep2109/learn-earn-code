    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="form-group">
                <label class="text-dark" for="status"><?php echo e(__('TextLogo')); ?> :</label><br>
        ...
        <div class="col-md-6">
            <div class="form-group">
                <label class="text-dark"><?php echo e(__('ProjectTitle')); ?>:</label>
        ...
        <div class="col-md-6">
            <div class="form-group">
                <label class="text-dark"><?php echo e(__('APPURL')); ?>:</label>
        ...
        <div class="col-md-6">
            <div class="form-group">
                <label class="text-dark" for="cpy_txt"><?php echo e(__('CopyrightText')); ?> : <span
                        class="text-danger">*</span></label>
        ...
        <div class="bg-info-rgba col-md-12 ml-3 mr-3 mb-3">
            <h4 class="mt-3 mb-3"><i class="feather icon-settings" aria-hidden="true"></i><?php echo e(__(' MapCoordinates Settings')); ?></h4>
            <div class="col-md-12">
                <div class="form-group">
                    <label class="text-dark" for="map_lat"><?php echo e(__('MapEnable')); ?>:</label><br>
            ...
            <div class="col-md-12">
                <div class="row" style="<?php echo e($setting['map_enable'] == 'map' ? '' : 'display:none'); ?>" id="sec1_one">
                    <div class="col-md-4">
                        ...
                        <input value="<?php echo e($setting->map_url); ?>" name="map_url" placeholder="Enter the iframe url" type="text"
                            class="<?php echo e($errors->has('map_url') ? ' is-invalid' : ''); ?> form-control">
                    </div>
                    
                    <div class="col-md-4">
                        <label class="text-dark" for="map_api"><?php echo e(__('MapApiKey')); ?>:</label>
        ...
        <div class="bg-info-rgba col-md-12 ml-3 mr-3 mb-3">
            ...
            <h4 class="mt-3 mb-3"><i class="feather icon-server"
                    aria-hidden="true"></i><?php echo e(__('PromoBar')); ?></h4>
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        <label class="text-dark" for="promo_enable"><?php echo e(__('PromoEnable')); ?>
            ...
            <div class="row" style="<?php echo e($setting['promo_enable'] == 1 ? '' : 'display:none'); ?>" id="sec2_one">
                <div class="col-md-6">
                    <label for="promo_text"><?php echo e(__('PromoText')); ?>:</label>
                ...
                <div class="col-md-6">
                    <label for="promo_link"><?php echo e(__('PromoLink')); ?>:</label>
        ...
        <div class="bg-info-rgba col-md-12 ml-3 mr-3 mb-3">
            <h4 class="mt-3 mb-3"><i class="feather icon-settings" aria-hidden="true"></i> <?php echo e(__('App Settings')); ?></h4>
            <div class="row">
                <div class="col-md-2">
                    <div class="form-group">
        ...
        <div class="bg-info-rgba col-md-12 ml-3 mr-3 mb-3">
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        <label class="text-dark"><?php echo e(__('RightClick')); ?> :</label><br>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label class="text-dark"><?php echo e(__('InspectElement')); ?> :</label><br>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label class="text-dark"><?php echo e(__('PreloaderEnable')); ?> :</label><br>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label class="text-dark"><?php echo e(__('APPDebug')); ?> :</label><br>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        <label class="text-dark"><?php echo e(__('WelcomeEmail')); ?> : </label><br>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label class="text-dark"><?php echo e(__('VerifyEmail')); ?> : </label><br>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label class="text-dark"><?php echo e(__('BecomeAnInstructor')); ?>: </label><br>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label class="text-dark"><?php echo e(__('CategoryMenu')); ?> :</label><br>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label class="text-dark"><?php echo e(__('DeviceControl')); ?> :</label><br>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label class="text-dark"><?php echo e(__('CookieNotice')); ?> :</label><br>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label class="text-dark"><?php echo e(__('IPBlock')); ?> :</label><br>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        <label class="text-dark"><?php echo e(__('ActivityLog')); ?> :</label><br>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label class="text-dark"><?php echo e(__('Assignment')); ?> :</label><br>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label class="text-dark"><?php echo e(__('Appointment')); ?> :</label><br>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label class="text-dark"><?php echo e(__('CertificateEnable')); ?> :</label><br>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        <label class="text-dark"><?php echo e(__('HideIdentity')); ?> :</label><br>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label class="text-dark"><?php echo e(__('CourseHover')); ?> :</label><br>
        ...
        <div class="bg-info-rgba col-md-12 ml-3 mr-3 mb-3">
            <h4 class="mt-3 mb-3"><i class="feather icon-loader" aria-hidden="true"></i> <?php echo e(__('Meeting Settings')); ?>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label class="text-dark"><?php echo e(__('GoogleMeet')); ?> :</label><br>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label class="text-dark"><?php echo e(__('JitsiMeeting')); ?> :</label><br>
        ...
        <div class="col-md-6">
            <div class="row">
                ...
                <div class="col-md-3 p-3 bg-primary-rgba">
                    <img src="<?php echo e(url('/images/logo/'.$setting->logo)); ?>" class="img-fluid" />
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="row mb-4">
                <div class="col-md-9">
                    <label class="text-dark"><?php echo e(__('footerlogo')); ?> :</label>
                    <small><?php echo e(__('(Note - Size : 300x90)')); ?></small>
        ...
        <div class="form-group col-md-6">
            ...
            <div class="row">
                <div class="col-md-9">
                    <label class="text-dark"><?php echo e(__('Preloaderlogo')); ?> :</label>
                    <small><?php echo e(__('(Note - Size : 300x90)')); ?></small>
        ...
        <div class="form-group col-md-6">
            <div class="row">
                ...
                <div class="bg-primary-rgba p-3 col-md-3">
                    ...
                    <img src="<?php echo e(url('/images/favicon/'.$setting->favicon)); ?>" class="logo_img img-fluid" />
                    <?php endif; ?>
                </div>
            </div>
        </div>
...
<script>
    ...
    <?php $__env->stopSection(); ?> <?php /**PATH /home/eui6ftgy1hdt/public_html/resources/views/admin/setting/genral.blade.php ENDPATH**/ ?>