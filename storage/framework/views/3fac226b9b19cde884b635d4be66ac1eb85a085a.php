                                ...
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col-6">
                                            ...
                                            <p class="font-14 mb-0"><?php echo e(__('BBL Meetings')); ?></p>
                                        </div>
                            ...
                            <div class="card m-b-30 shadow-sm">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-6 text-right">
                                            <a href="<?php echo e(url('allinstructor')); ?>"><i
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card m-b-30 mt-md-2">
                            <div class="card-header">
                                <h5 class="card-title"><?php echo e(__('Monthly Registred Users in 2022')); ?></h5>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-lg-6 col-md-12 mt-md-3 chart_height">
                        <div class="card m-b-30">
                            <div class="card-header">
                                <h5 class="card-title"><?php echo e(__('Total Orders in 2022')); ?></h5>
                            </div>
                            <div class="card-body">
                                <div id="apex-chart">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="upcomingTask">
                                                <a href="<?php echo e(url('course')); ?>"
                                                    class="dropdown-item font-13"><?php echo e(__('ViewAll')); ?></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="upcomingTask">
                                                <a href="<?php echo e(route('all.instructor')); ?>"
                                                    class="dropdown-item font-13"><?php echo e(__('AllInstructor')); ?></a>
                                                <a href="<?php echo e(url('requestinstructor')); ?>"
                                                    class="dropdown-item font-13"><?php echo e(__('ViewAllInstructor')); ?></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="text-right">
                                            <h6><?php echo e(__('Resume')); ?>:
                                                <a href="<?php echo e(asset('files/instructor/'.$instructor['file'])); ?>"
                                                    download="<?php echo e($instructor['file']); ?>"><?php echo e(__('Download')); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/eui6ftgy1hdt/public_html/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>