                    ...
                    <div class="table-responsive">
                        <table id="datatable" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?php echo $i; ?></td>
                                    <td><?php echo e($following->user->fname); ?></td>
                                    <td><?php echo e($following->user->email); ?></td>
...
<!-- </div> -->
<?php /**PATH /home/eui6ftgy1hdt/public_html/resources/views/admin/follower/following.blade.php ENDPATH**/ ?>