    ...
    <div class="col-lg-12">
      ...
      <div class="card dashboard-card m-b-30">
                ...
                <ul class="nav nav-tabs mb-3" id="defaultTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="home-tab" data-toggle="tab" href="#facebook" role="tab" aria-controls="home" aria-selected="true"><?php echo e(__('GeneralSetting')); ?></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="profile-tab" data-toggle="tab" href="#google" role="tab" aria-controls="profile" aria-selected="false"><?php echo e(__('SeoSetting')); ?></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="profile-tab" data-toggle="tab" href="#twitter" role="tab" aria-controls="profile" aria-selected="false"><?php echo e(__('MailSetting')); ?></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="profile-tab" data-toggle="tab" href="#linkedin" role="tab" aria-controls="profile" aria-selected="false"><?php echo e(__('CustomStyleandJS')); ?></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="profile-tab" data-toggle="tab" href="#amazon" role="tab" aria-controls="profile" aria-selected="false">&nbsp;&nbsp;<?php echo e(__('SocialLoginSetting')); ?></a>
                        </li>
                      <li class="nav-item">
                        <a class="nav-link" id="profile-tab" data-toggle="tab" href="#whatsapp" role="tab" aria-controls="profile" aria-selected="false">&nbsp;&nbsp;<?php echo e(__('Whatsapp Chat')); ?></a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" id="profile-tab" data-toggle="tab" href="#faceboo" role="tab" aria-controls="profile" aria-selected="false">&nbsp;&nbsp;<?php echo e(__('Facebook Chat')); ?></a>
                  </li>
                  <li class="nav-item">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/eui6ftgy1hdt/public_html/resources/views/admin/setting/setting.blade.php ENDPATH**/ ?>