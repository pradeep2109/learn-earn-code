            ...
            <div class="row">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control state" placeholder="<?php echo e(__('Please')); ?> <?php echo e(__('Enter')); ?> State" value="<?php echo e($states?$states->name:''); ?>" readonly>     
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input value="<?php echo e($user->lname); ?>" required name="lname" type="text" class="form-control"
                    placeholder="<?php echo e(__('Enter')); ?> <?php echo e(__('Last Name')); ?>" />
                </div>
               ...
               <div class="form-group">
                  ...
                  <input type="text" class="form-control country" placeholder="<?php echo e(__('Please')); ?> <?php echo e(__('Enter')); ?> Country" value="<?php echo e($countries?$countries->name:''); ?>" readonly>     
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/eui6ftgy1hdt/public_html/resources/views/admin/user/edit.blade.php ENDPATH**/ ?>