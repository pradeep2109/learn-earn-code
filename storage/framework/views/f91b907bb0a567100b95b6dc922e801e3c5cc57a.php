        ...
        <div class="card-header">
          ...
          <div>
            <div class="widgetbar">
              ...
              <a href="<?php echo e(route('institute.create')); ?>" class="btn btn-primary-rgba"><i
                  class="feather icon-plus mr-2"></i><?php echo e(__("Add Institute")); ?></a>
              <?php endif; ?>
              <?php echo e(csrf_field()); ?>

              <a href="<?php echo e(route('institute.import')); ?>" class="btn btn-success-rgba"><i
                  ...
                  <td>
                    <div class="dropdown">
                      ...
                      <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton3">
                        <a class="dropdown-item" href="<?php echo e(route('institute.edit',['id' => $item->id])); ?>"><i
                            class="feather icon-edit mr-2"></i><?php echo e(__("Edit")); ?></a>
                        <a class="dropdown-item" data-toggle="modal"  data-target="#delete<?php echo e($item->id); ?>"><i
                  ...
                  <td>
                    <div class="dropdown">
                      ...
                      <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton3">
                        ...
                        <a class="dropdown-item" href="<?php echo e(route('institute.edit',['id' => $value->id])); ?>"><i
                            class="feather icon-edit mr-2"></i><?php echo e(__("Edit")); ?></a>
                        <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/eui6ftgy1hdt/public_html/resources/views/admin/Institute/index.blade.php ENDPATH**/ ?>