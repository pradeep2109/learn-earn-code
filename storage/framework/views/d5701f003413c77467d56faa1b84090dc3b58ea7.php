...
<?php $__env->startSection('title','Create a new user'); ?>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input value="<?php echo e(old('fname')); ?>" autofocus required name="fname" type="text" class="form-control"
                      placeholder="<?php echo e(__('Please')); ?> <?php echo e(__('Enter')); ?> <?php echo e(__('First Name')); ?>" />
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <label class="text-dark" for="role"><?php echo e(__('Select Role')); ?>: <sup
                        class="text-danger">*</sup></label>
                    <select class="form-control select2" name="role" required>
                      <option value="none" selected disabled hidden>
                        <?php echo e(__('Please')); ?> <?php echo e(__('Select an Option')); ?>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input value="<?php echo e(old('lname')); ?>" required name="lname" type="text" class="form-control"
                      placeholder="<?php echo e(__('Please')); ?> <?php echo e(__('Enter')); ?> <?php echo e(__('Last Name')); ?>" />
                  </div>

                
                  <div class="form-group">
                    <label class="text-dark" for="mobile"><?php echo e(__('Mobile')); ?>: <sup class="text-danger">*</sup></label>
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control state" placeholder="<?php echo e(__('Please')); ?> <?php echo e(__('Enter')); ?> State" readonly>     
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="<?php echo e(__('Please')); ?> <?php echo e(__('Enter')); ?> City" onchange="get_state_country(this.value)" required>
                    <input type="hidden" name="city_id" class="city_id"> 
                    <span class="error text-danger"></span>
                  </div>
                  <div class="form-group">
                    <label class="text-dark" for="city_id"><?php echo e(__('Country')); ?>: </label> 
                    <input type="text" class="form-control country" placeholder="<?php echo e(__('Please')); ?> <?php echo e(__('Enter')); ?> Country" readonly>     
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/eui6ftgy1hdt/public_html/resources/views/admin/user/adduser.blade.php ENDPATH**/ ?>