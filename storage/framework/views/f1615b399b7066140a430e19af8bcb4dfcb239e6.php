        ...
        <div class="card-header">
          ...
          <div>
            <div class="widgetbar">
              ...
              <a href="<?php echo e(route('order.create')); ?>" class="btn btn-primary-rgba mr-2"><i class="feather icon-plus mr-2"></i><?php echo e(__('Enroll User')); ?></a>
              <a href="<?php echo e(route('order.fileexport')); ?>" class="btn btn-primary-rgba"> <i class="feather icon-download mr-2"></i><?php echo e(__('Export Offline Payments')); ?></a>
              <?php endif; ?>
            </div>
          </div>
        </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/eui6ftgy1hdt/public_html/resources/views/admin/order/show.blade.php ENDPATH**/ ?>