          ...
          <div class="card-footer">
            <div class="row">
              <div class="col-lg-12 text-right">
                <a href="<?php echo e(route('instructor.course.show',['id' => $cat->id, 'slug' => $cat->slug ])); ?>" title="Show" type="button" class="btn btn-primary">View
                </a>
              </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/eui6ftgy1hdt/public_html/resources/views/admin/course/instructor_course.blade.php ENDPATH**/ ?>