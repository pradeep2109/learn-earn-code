<div class="leftbar sidebar-two" style="background-image: url('images/navbar.png')">
                        ...
                        <ul class="vertical-menu">
                            ...
                            <li class="<?php echo e(Nav::isRoute('user.index')); ?> <?php echo e(Nav::isRoute('user.subscribe')); ?> <?php echo e(Nav::isRoute('user.unsubscribe')); ?> <?php echo e(Nav::isRoute('user.last_7_days')); ?> <?php echo e(Nav::isRoute('user.add')); ?> <?php echo e(Nav::isRoute('user.edit')); ?><?php echo e(Nav::isRoute('alluser.index')); ?> <?php echo e(Nav::isRoute('alluser.add')); ?> <?php echo e(Nav::isRoute('alluser.edit')); ?><?php echo e(Nav::isRoute('allinstructor.index')); ?> <?php echo e(Nav::isRoute('allinstructor.add')); ?> <?php echo e(Nav::isRoute('allinstructor.edit')); ?><?php echo e(Nav::isResource('roles')); ?>">
                                ...
                                <ul class="vertical-submenu">
                                    ...
                                    <li>
                                        <a class="<?php echo e(Nav::isResource('user')); ?>"
                                            href="<?php echo e(route('user.subscribe')); ?>"><?php echo e(__('Subscribe Users')); ?></a>
                                    </li>
                                    <li>
                                        <a class="<?php echo e(Nav::isResource('user')); ?>"
                                            href="<?php echo e(route('user.last_7_days')); ?>"><?php echo e(__('Last 7 Days Register Users')); ?></a>
                                    </li>
                                    <li>
                                        <a class="<?php echo e(Nav::isResource('user')); ?>"
                                            href="<?php echo e(route('user.unsubscribe')); ?>"><?php echo e(__('Unsubscribe Users')); ?></a>
                                    </li>
                                    <li>
    ...
    <!-- End Sidebar -->
</div><?php /**PATH /home/eui6ftgy1hdt/public_html/resources/views/admin/layouts/new_sidebar.blade.php ENDPATH**/ ?>