        ...
        <div class="card-body">
          ...
          <div class="row">
            <div class="form-group col-md-6">
              ...
              <input class="form-control" type="text" name="heading" placeholder="<?php echo e(__('Enter')); ?> <?php echo e(__('Heading')); ?>">
              
            </div>
            <div class="form-group col-md-6">
              <label for="exampleInputSlug"><?php echo e(__('SubHeading')); ?>:<sup class="redstar text-danger">*</sup></label>
                  <input type="slug" class="form-control" name="sub_heading" id="exampleInputPassword1" placeholder="<?php echo e(__('Enter')); ?> <?php echo e(__('SubHeading')); ?>">
            </div>

            <div class="d-none">
              <label for="exampleInputTit1e d-none"><?php echo e(__('SearchText')); ?>:<sup class="redstar text-danger">*</sup></label>
              <input type="text" class="form-control display-none" name="search_text" id="exampleInputTitle" value="0">
            </div>
            <div class="form-group col-md-12">
              <label for="exampleInputDetails"><?php echo e(__('Detail')); ?>:<sup class="redstar text-danger">*</sup></label>
              <textarea name="detail" rows="3" class="form-control" placeholder="<?php echo e(__('Enter')); ?> <?php echo e(__('Detail')); ?>"></textarea>
            </div>
            ...
            <div class="form-group col-md-2">
              <label for="exampleInputDetails"><?php echo e(__('TextPosition')); ?>:</label><br>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/eui6ftgy1hdt/public_html/resources/views/admin/slider/insert.blade.php ENDPATH**/ ?>