    ...
    <div class="col-lg-12">
      <div class="card m-b-30">
        <div class="card-header">
          <h5 class="box-tittle"><?php echo e(__('Add')); ?> <?php echo e(__('Course')); ?></h5>
          <div>
            <div class="widgetbar">
              <a href="<?php echo e(route('course.index')); ?>" class="float-right btn btn-primary-rgba mr-2"><i class="feather icon-arrow-left mr-2"></i><?php echo e(__('Back')); ?></a>
            </div>
          </div>
        </div>
        <div class="card-body">
          <form action="<?php echo e(url('course/')); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
              ...
              <div class="col-md-3">
                <label for="exampleInputTit1e"><?php echo e(__('Instructor')); ?></label>
              ...
              <div class="col-md-12">
                <div class="form-group">
                  <label><?php echo e(__("Also in :")); ?> <span class="redstar">*</span></label>
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <input type="title" class="form-control" name="title" id="exampleInputTitle" placeholder="<?php echo e(__('Enter')); ?> <?php echo e(__('Title')); ?>" value="<?php echo e((old('title'))); ?>" required>
              </div>
              <div class="col-md-6">
                <label for="exampleInputSlug"><?php echo e(__('Slug')); ?>: <sup class="redstar">*</sup></label>
                <input pattern="[/^\S*$/]+" type="text" class="form-control" name="slug" id="exampleInputPassword1" placeholder="<?php echo e(__('Enter')); ?> <?php echo e(__('Slug')); ?>" value="<?php echo e((old('slug'))); ?>" required>
              </div>
            </div>
            <br>
            ...
            <div class="row">
              <div class="col-md-6">
                <label for="exampleInputTit1e"><?php echo e(__('ShortDetail')); ?>: <sup class="redstar">*</sup></label>
                <textarea name="short_detail" rows="3" class="form-control" placeholder="<?php echo e(__('Enter')); ?> <?php echo e(__('ShortDetail')); ?>" required><?php echo e((old('short_detail'))); ?></textarea>
              </div>
              <div class="col-md-6">
                <label for="exampleInputTit1e"><?php echo e(__('Requirements')); ?>: <sup class="redstar">*</sup></label>
                <textarea name="requirement" rows="3" class="form-control" placeholder="<?php echo e(__('Enter')); ?> <?php echo e(__('Requirements')); ?>" required><?php echo e((old('requirement'))); ?></textarea>
              </div>
            </div>
            <br>
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <label for="exampleInputSlug"><?php echo e(__('SelectTags')); ?>:</label>
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <label><?php echo e(__('CourseTags')); ?>: <span class="redstar">*</span></label>
            ...
            <div class="row">
              <div class="col-md-12 d-none">
                ...
                <label for="exampleInputSlug"><?php echo e(__('ReturnAvailable')); ?></label>
            ...
            <div class="col-md-3">
              <label for="exampleInputDetails"><?php echo e(__('InvolvementRequest')); ?>:</label>
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <div style="display: none;" id="document1">
              <label for="exampleInputSlug"><?php echo e(__('UploadVideo')); ?>:</label>
              <input type="file" name="video" id="video" value="" class="form-control">
            </div>
            <div id="document2">
              <label for=""><?php echo e(__('URL')); ?>: </label>
              <input type="url" name="url" id="url" placeholder="<?php echo e(__('Enter')); ?> <?php echo e(__('URL')); ?>" class="form-control" value="<?php echo e((old('url'))); ?>">
            </div>
          </div>
        ...
        <div class="row">
          <?php if(Auth::user()->role == 'instructor'): ?>
          <div class="col-md-6">
            <label class="text-dark" for="exampleInputSlug"><?php echo e(__('PreviewImage')); ?>: </label>
          ...
          <div class="col-md-6">
            <?php if(Auth::User()->role == "admin"): ?>
            <label for="Revenue"><?php echo e(__('InstructorRevenue')); ?>:</label>
            <div class="input-group">
              <input min="1" max="100" class="form-control" name="instructor_revenue" type="number" id="revenue" placeholder="<?php echo e(__('Enter')); ?> revenue percentage" class="<?php echo e($errors->has('instructor_revenue') ? ' is-invalid' : ''); ?> form-control" value="<?php echo e((old('instructor_revenue'))); ?>">
        ...
        <div class="row">
          ...
          <div class="col-sm-3">
            <label for="exampleInputDetails"><?php echo e(__('CertificateEnable')); ?>:</label>
          ...
          <div class="col-sm-3">
            <label for=""><?php echo e(__('DripContent')); ?>: </label>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/eui6ftgy1hdt/public_html/resources/views/admin/course/insert.blade.php ENDPATH**/ ?>