        ...
        <div class="card dashboard-card m-b-30">
             <!-- Card header will display you the heading -->
                <div class="card-header">
                    <h5 class="card-box"><?php echo e(__('ColorSettings')); ?></h5>
                    <div>
                        <div class="widgetbar">
                            <a href="<?php echo e(route('coloroption.reset')); ?>" class="btn btn-primary-rgba"><i class="feather icon-plus mr-2"></i><?php echo e(__("Reset")); ?></a>
                                ...
                                <a href="<?php echo e(url('theme/settings')); ?>" class="btn btn-primary-rgba"><i class="feather icon-arrow-left mr-2"></i><?php echo e(__("Back")); ?></a>
                            </div>                        
                      </div>
                </div> 
                <!-- card body started -->
                                                  ...
                                                  <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group">
															<label class="text-dark" for="blue_bg"><?php echo e(__('BlueBackground')); ?>:</label>
													...
													<div class="col-md-6">
                                                        <div class="form-group">
															<label class="text-dark" for="red_bg"><?php echo e(__('RedBackground')); ?> :</label>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/eui6ftgy1hdt/public_html/resources/views/admin/coloroption/view.blade.php ENDPATH**/ ?>