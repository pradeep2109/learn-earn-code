    ...
    <div class="col-lg-12">
      <div class="card dashboard-card m-b-30">
                ...
                <div class="card-header">
                    <h5 class="card-box"><?php echo e(__('Addon')); ?> <?php echo e(__('Manager')); ?></h5>
                </div> 
                <div>
                  <div class="widgetbar">
                ...
                <div class="table-responsive">
                        ...
                        <?php $i=0;?>
                          <?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <button type="button" class="btn btn-rounded <?php echo e($module->isStatus(1) ? 'btn-success-rgba' : 'btn-danger-rgba'); ?>" data-toggle="modal" data-target="#myModal-<?php echo e($json['name']); ?>">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/eui6ftgy1hdt/public_html/resources/views/admin/addon/index.blade.php ENDPATH**/ ?>