      ...
      <div class="card m-b-30">
        ...
        <div class="card-body ml-2">
          <form enctype="multipart/form-data" id="demo-form" method="post" action="<?php echo e(url('courseclass/'.$cate->id)); ?>"data-parsley-validate class="form-horizontal form-label-left">
            ...
            <div class="row">
              <div class="col-md-12">
                <label for="exampleInputDetails"><?php echo e(__('LearningMaterial')); ?></label> - <p class="inline info">eg: zip or pdf files</p>
                  <!-- =========== -->
                  <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="inputGroupFileAddon01"><?php echo e(__('Upload')); ?></span>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/eui6ftgy1hdt/public_html/resources/views/admin/course/courseclass/edit.blade.php ENDPATH**/ ?>