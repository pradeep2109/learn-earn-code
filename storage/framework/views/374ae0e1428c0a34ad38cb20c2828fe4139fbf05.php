...
<?php $__env->startSection('title', 'Add Blog - Admin'); ?>
        ...
        <div class="card dashboard-card m-b-30">
            <!-- Card header will display you the heading -->
                <div class="card-header">
                    <h5 class="card-box"> <?php echo e(__('AddBlog')); ?></h5>
                    <div>
                        <div class="widgetbar">
                        <a href="<?php echo e(url('blog')); ?>" class="btn btn-primary-rgba"><i class="feather icon-arrow-left mr-2"></i><?php echo e(__("Back")); ?></a>
                        </div>
                      </div>
                </div> 
...
unset($__errorArgs, $__bag); ?>" placeholder="<?php echo e(__('Enter')); ?> <?php echo e(__('Slug')); ?>" name="slug" required="">
...
unset($__errorArgs, $__bag); ?>" placeholder="<?php echo e(__('Enter')); ?> <?php echo e(__('ButtonText')); ?>" name="text" required="">
...
unset($__errorArgs, $__bag); ?>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="date" class="form-control" name="date" id="inputDate" placeholder="<?php echo e(__('Select')); ?> <?php echo e(__('Date')); ?>" required>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/eui6ftgy1hdt/public_html/resources/views/admin/blog/create.blade.php ENDPATH**/ ?>