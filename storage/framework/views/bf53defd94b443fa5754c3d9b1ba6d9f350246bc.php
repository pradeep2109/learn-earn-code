                  ...
                  <?php if(file_exists(public_path().'/'.$path)): ?>
                    ...
                    <div class="col-md-12">
                        ...
                        <form action="<?php echo e(action('SiteMapController@download')); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                            <button type="submit" class="float-left btn btn-primary-rgba"><i class="feather icon-download"></i> <?php echo e(__('Download Sitemap')); ?></button>
                            </div>
			                 </form>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/eui6ftgy1hdt/public_html/resources/views/admin/sitemap/edit.blade.php ENDPATH**/ ?>