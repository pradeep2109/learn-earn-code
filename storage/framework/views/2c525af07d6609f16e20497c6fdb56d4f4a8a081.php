                                        ...
                                        <?php else: ?>
                                            ...
                                            ?>
                                                <?php if($coursechapter->goal_date>=$startDate): ?>
                                                    <small class="text-danger">Please complete your goal only 
                                                    <?php if($dff==0): ?>
                                                    Today
                                                    <?php else: ?>
                                                    <?php echo e($dff); ?> days 
                                                    ...
                                                    left</small><br>
                                                <?php else: ?> 
                                                <small class="text-danger">Your goal date is expired <?php echo e($coursechapter->goal_date); ?></small><br>
                                                <?php endif; ?>
                                            <?php endif; ?>
                                        <?php endif; ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-2 col-4">
                                    <div class="text-right">
                                        ...
                                        <?php if(isset($progress->mark_chapter_id) && in_array($coursechapter->id, $progress->mark_chapter_id)): ?>
                                            <?php if(isset($coursechapter->goal_date)): ?>
                                            Goal Date <?php echo e($coursechapter->goal_date); ?>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="goaldateLabel">Set Goal Date</h5>
...
</div><?php /**PATH /home/eui6ftgy1hdt/public_html/resources/views/include/course_chapter.blade.php ENDPATH**/ ?>