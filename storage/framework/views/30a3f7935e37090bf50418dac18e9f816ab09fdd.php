	...
	<div class="row">
		<div class="col-md-6">
			<div class="form-group<?php echo e($errors->has('meta_data_desc') ? ' has-error' : ''); ?>">
				<label class="text-dark" for=""><?php echo e(__('MetaDataDescription')); ?> :</label>
		...
		<div class="col-md-6">
			<div class="form-group<?php echo e($errors->has('meta_data_keyword') ? ' has-error' : ''); ?>">
				<label class="text-dark" for=""><?php echo e(__('MetaDataKeywords')); ?> :</label>
	...
	<div class="row">
		<div class="col-md-6">
			<div class="form-group<?php echo e($errors->has('google_ana') ? ' has-error' : ''); ?>">
				<label class="text-dark" for=""><?php echo e(__('GoogleAnalyticKey')); ?> :</label>
		...
		<div class="col-md-6">
			<div class="form-group<?php echo e($errors->has('fb_pixel') ? ' has-error' : ''); ?>">
				<label class="text-dark" for=""><?php echo e(__('FacebookPixelCode')); ?> :</label>
...
<?php /**PATH /home/eui6ftgy1hdt/public_html/resources/views/admin/setting/seo.blade.php ENDPATH**/ ?>