                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="text-dark"><?php echo e(__('Client Secret KEY :')); ?></label>
                                                                ...
                                                                <small class="text-info"><i class="fa fa-question-circle"></i> <?php echo e(__('Client Api key')); ?>.</small>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <small class="text-info"><i class="fa fa-question-circle"></i> <?php echo e(__('Enter envanto mobile app purchase code')); ?>.</small>
                                                            </div>
                                                        </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/eui6ftgy1hdt/public_html/resources/views/admin/apikeys/getkey.blade.php ENDPATH**/ ?>