<div class="dropdown">
    ...
    <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Alluser.edit')): ?>
        <a class="dropdown-item" href="<?php echo e(route('user.edit',$id)); ?>"><i
...
<!-- delete Model ended --><?php /**PATH /home/eui6ftgy1hdt/public_html/resources/views/admin/alluser/action.blade.php ENDPATH**/ ?>