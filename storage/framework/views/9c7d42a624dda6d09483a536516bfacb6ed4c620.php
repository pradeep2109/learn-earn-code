...
<?php $__env->startSection('title', 'Themes - Admin'); ?>
	  ...
	  <div class="col-lg-12">
		...
		<div class="card m-b-30">
		  <div class="card-header">
			<h5 class="card-title"><?php echo e(__('Theme Settings')); ?></h5>
			<div>
				<div class="widgetbar">
					<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('themes.manage')): ?>
					<a href="<?php echo e(route('add.theme')); ?>" class="float-right btn btn-primary-rgba mr-2">
				...
				<div class="row">
					...
					<div class="shadow-sm border card col-md-6" style="width: 18rem;">
						...
						<div class="card-body">
						    ...
						    <p class="card-text">
								<?php echo e(__('eClass Blizzard Vue SPA Theme.')); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/eui6ftgy1hdt/public_html/resources/views/admin/theme/edit.blade.php ENDPATH**/ ?>