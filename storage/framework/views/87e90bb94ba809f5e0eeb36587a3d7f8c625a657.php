    ...
    <div class="col-lg-12">
         <div class="card dashboard-card m-b-30">
                ...
                <div class="card-header">
                    <h5 class="card-box"><?php echo e(__('AllMessage')); ?></h5>
                    <div>
                        <div class="widgetbar">
                ...
                <div class="table-responsive">
                        ...
                        <?php $i++;?>
                            ...
                            <div class="modal-dialog modal-sm">
                                ...
                                <td><?php echo e(str_limit($item->reason, $limit = 50, $end = '...')); ?></td>
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('contact-us.manage')): ?>
                                            <a class="dropdown-item" href="<?php echo e(route('usermessage.edit',$item->id)); ?>"><i class="feather icon-eye mr-2"></i><?php echo e(__('View')); ?></a>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/eui6ftgy1hdt/public_html/resources/views/admin/contact/index.blade.php ENDPATH**/ ?>